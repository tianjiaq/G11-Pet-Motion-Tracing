...
CONFIG.PHASE {0.0} \
  ...
  # Create instance: ObjectDetection_0, and set properties
  set ObjectDetection_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ObjectDetection:1.0 ObjectDetection_0 ]
...
CONFIG.kRstActiveHigh {false} \
  ...
  # Create instance: rst_hdmi_160M, and set properties
  set rst_hdmi_160M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_hdmi_160M ]
  set_property -dict [ list \
CONFIG.RESET_BOARD_INTERFACE {reset} \
CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_hdmi_160M
...
CONFIG.C_HAS_ASYNC_CLK {1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ObjectDetection_0_M00_AXIS [get_bd_intf_pins ObjectDetection_0/M00_AXIS] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins ObjectDetection_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins PmodWIFI_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins PmodWIFI_0/S_AXI_TIMER] [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins PmodWIFI_0/AXI_LITE_WFCS] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M12_AXI [get_bd_intf_pins PmodWIFI_0/AXI_LITE_WFGPIO] [get_bd_intf_pins microblaze_0_axi_periph/M12_AXI]
  ...
  connect_bd_intf_net -intf_net v_vid_in_axi4s_0_video_out [get_bd_intf_pins ObjectDetection_0/S00_AXIS] [get_bd_intf_pins v_vid_in_axi4s_0/video_out]
  ...
  # Create port connections
  connect_bd_net -net ObjectDetection_0_d_out [get_bd_pins ObjectDetection_0/d_out] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net ObjectDetection_0_d_out1 [get_bd_pins ObjectDetection_0/d_out1] [get_bd_pins blk_mem_gen_1/dina]
  connect_bd_net -net ObjectDetection_0_r_addr [get_bd_pins ObjectDetection_0/r_addr] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net ObjectDetection_0_r_addr1 [get_bd_pins ObjectDetection_0/r_addr1] [get_bd_pins blk_mem_gen_1/addrb]
  connect_bd_net -net ObjectDetection_0_w_addr [get_bd_pins ObjectDetection_0/w_addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net ObjectDetection_0_w_addr1 [get_bd_pins ObjectDetection_0/w_addr1] [get_bd_pins blk_mem_gen_1/addra]
  connect_bd_net -net ObjectDetection_0_w_en [get_bd_pins ObjectDetection_0/w_en] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net ObjectDetection_0_w_en1 [get_bd_pins ObjectDetection_0/w_en1] [get_bd_pins blk_mem_gen_1/wea]
  connect_bd_net -net PmodWIFI_0_WF_INTERRUPT [get_bd_pins PmodWIFI_0/WF_INTERRUPT] [get_bd_pins microblaze_0_xlconcat/In6]
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins ObjectDetection_0/d_in] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins ObjectDetection_0/d_in1] [get_bd_pins blk_mem_gen_1/doutb]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_0 [get_bd_pins ObjectDetection_0/m00_axis_aclk] [get_bd_pins ObjectDetection_0/s00_axi_aclk] [get_bd_pins ObjectDetection_0/s00_axis_aclk] [get_bd_pins PmodWIFI_0/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/M10_ACLK] [get_bd_pins microblaze_0_axi_periph/M11_ACLK] [get_bd_pins microblaze_0_axi_periph/M12_ACLK] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins rst_hdmi_160M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_hdmi_160M/ext_reset_in] [get_bd_pins rst_mig_7series_0_pxl/ext_reset_in]
  connect_bd_net -net rst_hdmi_160M_peripheral_aresetn [get_bd_pins PmodWIFI_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M10_ARESETN] [get_bd_pins microblaze_0_axi_periph/M11_ARESETN] [get_bd_pins microblaze_0_axi_periph/M12_ARESETN] [get_bd_pins rst_hdmi_160M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs ObjectDetection_0/S00_AXI/S00_AXI_reg] SEG_ObjectDetection_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs ObjectDetection_0/S00_AXI/S00_AXI_reg] SEG_ObjectDetection_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_SPI/Reg0] SEG_PmodWIFI_0_Reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A70000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_GPIO_WFCS/Reg0] SEG_PmodWIFI_0_Reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodWIFI_0/S_AXI_TIMER/Reg0] SEG_PmodWIFI_0_Reg01
  create_bd_addr_seg -range 0x00010000 -offset 0x44A70000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_GPIO_WFCS/Reg0] SEG_PmodWIFI_0_Reg02
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_WFGPIO/Reg0] SEG_PmodWIFI_0_Reg03
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_SPI/Reg0] SEG_PmodWIFI_0_Reg03
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodWIFI_0/AXI_LITE_WFGPIO/Reg0] SEG_PmodWIFI_0_Reg05
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodWIFI_0/S_AXI_TIMER/Reg0] SEG_PmodWIFI_0_Reg07
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_dynclk_0/s00_axi/reg0] SEG_axi_dynclk_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_video/S_AXI/Reg] SEG_axi_gpio_video_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs v_tc_0/ctrl/Reg] SEG_v_tc_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs v_tc_1/ctrl/Reg] SEG_v_tc_1_Reg
